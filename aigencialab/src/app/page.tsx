...
export const metadata: Metadata = {
  ...
  description: 'Agentes IA autónomos para ecommerce, clínicas y logística. Audita tu negocio gratis y descubre oportunidades de IA. Ley N°21.663 Chile.',
}
...
const services = [
  ...
  { icon: '💬', title: 'Soporte 24/7', desc: 'Agente IA que responde consultas, genera tickets y escala a humano.', tags: ['WhatsApp','FAQ','SLA'] },
  { icon: '🤖', title: 'Backoffice Automático', desc: 'Facturación SII, conciliaciones ERP y reportes automáticos sin intervención.', tags: ['SII','Defontana','Buk'] },
]
          ...
          <div className="max-w-6xl mx-auto px-6 py-24 relative z-10">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 text-blue-300 text-sm px-4 py-2 rounded-full mb-8 reveal">
                🇨🇱 Socio Tecnológico Enterprise · Ley N°21.663 · Ley N°19.628
              </div>
              <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6 reveal reveal-1">
                Automatización{' '}
                <span className="text-gradient">End-to-End</span>
                <br />para Empresas que Escalan.
              </h1>
              <p className="text-xl text-slate-400 max-w-2xl mb-10 leading-relaxed reveal reveal-2">
                Agentes de IA autónomos que sincronizan inventarios, rastrean envíos, predicen demanda y protegen tu infraestructura — desplegados en <strong className="text-slate-200">tu ecosistema chileno</strong> con cumplimiento normativo total.
              </p>
