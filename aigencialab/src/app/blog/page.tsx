...
const POSTS = [
  {
    ...
    category: 'Ventas', readTime: '5 min', date: 'Marzo 2026', emoji: '📈',
  },
  {
  ...
  },
  {
    ...
    category: 'Tecnología', readTime: '8 min', date: 'Diciembre 2025', emoji: '⚙️',
  },
  {
  ...
  },
  {
    ...
    excerpt: 'Cómo integrar agentes IA con WooCommerce, Shopify y Mercado Libre para automatizar soporte, stock y seguimiento de pedidos.',
    category: 'Tecnología', readTime: '7 min', date: 'Abril 2026', emoji: '🛒',
  },
  {
    slug: 'ley-21663-ia-empresas-chile',
    title: 'Ley N°21.663 y el uso de IA en empresas chilenas: lo que debes saber',
    excerpt: 'Chile es el primer país de LATAM con regulación de IA. Te explicamos las 4 obligaciones legales y cómo AIgenciaLab te ayuda a cumplirlas.',
    category: 'Tecnología', readTime: '6 min', date: 'Marzo 2026', emoji: '⚖️',
  },
  {
    slug: 'whatsapp-ia-triplicar-leads',
    title: 'WhatsApp Business + IA: cómo triplicar tus leads en 90 días',
    excerpt: 'WhatsApp tiene 98% de tasa de apertura. Con un agente IA conectado, se convierte en tu mejor vendedor 24/7 sin costo adicional de personal.',
    category: 'Ventas', readTime: '5 min', date: 'Marzo 2026', emoji: '📱',
  },
]
