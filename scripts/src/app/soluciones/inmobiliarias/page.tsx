    ...
    <MainLayout>
      <div className="bg-white">
        <header className="py-20 px-6 sm:px-12 text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900 mb-6">AIgenciaLab para Inmobiliarias</h1>
          <p className="text-lg text-gray-600 mb-8">Califica leads y agenda visitas de propiedades de forma automática.</p>
