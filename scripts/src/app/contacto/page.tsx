  ...
  return (
    <MainLayout>
      <div className="py-20 px-6 text-center max-w-4xl mx-auto min-h-[60vh]">
        <h1 className="text-4xl md:text-5xl font-bold capitalize mb-6">contacto</h1>
        <p className="text-lg text-gray-600 mb-8">Información sobre contacto próximamente.</p>
